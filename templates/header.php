...
<body class="bg-gray-100 flex">
    ...
    <aside id="sidebar" class="sidebar fixed top-0 left-0 h-full w-64 flex flex-col transition-transform duration-300 ease-in-out z-30">
        <div class="p-4 border-b border-green-300 flex justify-center items-center">
            <img id="logo" src="assets/images/kingdomsacco_dark.png" alt="KINGDOM SACCO Logo" class="h-10">
        </div>
        <nav class="flex-grow p-4 overflow-y-auto">
            <ul class="space-y-2">
                <li><a href="dashboard.php" class="block py-2 px-4 rounded hover:bg-green-400">Dashboard</a></li>

                <li class="pt-4">
                    <span class="px-4 text-xs font-semibold uppercase" style="color: var(--text-sidebar-muted)">Member Actions</span>
                </li>
                <li><a href="withdraw.php" class="block py-2 px-4 rounded hover:bg-green-400">Request Withdrawal</a></li>
                <li><a href="request_loan.php" class="block py-2 px-4 rounded hover:bg-green-400">Request Loan</a></li>
                <li><a href="repay_loan.php" class="block py-2 px-4 rounded hover:bg-green-400">Repay Loan</a></li>
                <li><a href="guarantor_requests.php" class="block py-2 px-4 rounded hover:bg-green-400">Guarantor Requests</a></li>
                <li><a href="generate_statement.php" class="block py-2 px-4 rounded hover:bg-green-400">Download Statement</a></li>
                <li><a href="member_directory.php" class="block py-2 px-4 rounded hover:bg-green-400">Member Directory</a></li>
                ...
                <?php if (in_array($role_id, [1, 2, 3, 4])): // Admin-level actions ?>
                    ...
                    <?php if (in_array($role_id, [1, 2, 3])): ?>
                        <li><a href="add_user.php" class="block py-2 px-4 rounded hover:bg-green-400">Add Member</a></li>
                    <?php endif; ?>
                    <li><a href="add_saving.php" class="block py-2 px-4 rounded hover:bg-green-400">Add Saving</a></li>
                    <li><a href="view_all_savings.php" class="block py-2 px-4 rounded hover:bg-green-400">View Savings</a></li>
                    <li><a href="manage_requests.php" class="block py-2 px-4 rounded hover:bg-green-400">Manage Requests</a></li>
                     <?php if (in_array($role_id, [1, 2])): ?>
                        <li><a href="apply_interest.php" class="block py-2 px-4 rounded hover:bg-green-400">Apply Interest</a></li>
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <?php if (in_array($role_id, [1, 2, 3, 4])): ?>
                    ...
                    <li><a href="reports.php" class="block py-2 px-4 rounded hover:bg-green-400">System Reports</a></li>
                <?php endif; ?>
                ...
                <?php if (in_array($role_id, [1, 2])): ?>
                    ...
                    <li><a href="admin_reset_password.php" class="block py-2 px-4 rounded hover:bg-green-400">Reset Member Password</a></li>
                    <li><a href="admin_audit_view.php" class="block py-2 px-4 rounded hover:bg-green-400">Audit View</a></li>
                    <li><a href="admin_analytics_view.php" class="block py-2 px-4 rounded hover:bg-green-400">Analytics View</a></li>
                    <li><a href="admin_tabular_view.php" class="block py-2 px-4 rounded hover:bg-green-400">Tabular View</a></li>
                <?php endif; ?>

                <?php if ($role_id == 2): ?>
                    <li><a href="handover.php" class="block py-2 px-4 rounded hover:bg-green-400">Handover Role</a></li>
                <?php endif; ?>
            </ul>
        </nav>
        <div class="p-4 border-t border-gray-700">
            <a href="settings.php" class="block py-2 px-4 rounded hover:bg-green-400">Settings</a>
            <a href="logout.php" class="block py-2 px-4 rounded hover:bg-green-400">Logout</a>
        </div>
    </aside>

    <!-- Main Content Area -->
    <div class="main-content flex-grow">
        <header class="shadow-md p-4 flex justify-between items-center w-full">
            <!-- Mobile Menu Button -->
            ...
            ?>
            <h1 class="text-xl font-bold hidden sm:block" style="color: var(--text-primary)"><?php echo htmlspecialchars($role_name); ?> of KINGDOM SACCO</h1>
